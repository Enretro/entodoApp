    ...
    async function go() {
      let client = new MongoClient("mongodb+srv://enres666:0101010101010101en666@cluster0.nyxzn.mongodb.net/TodoApp?retryWrites=true&w=majority")
    ...
    function passwdProtect(req, res, next) {
      res.set('WWW-Authenticate', 'Basic realm="Simple Todo App')
      console.log(req.headers.authorization)
      if (req.headers.authorization == "Basic ZW46ZW5yZXNlbg==") {
        next()
      } else {
